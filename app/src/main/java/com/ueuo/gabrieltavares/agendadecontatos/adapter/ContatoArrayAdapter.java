...
import com.ueuo.gabrieltavares.agendadecontatos.util.SeletorCoresUtil;
...
public class ContatoArrayAdapter extends ArrayAdapter<Contato>{
    ...
    SeletorCoresUtil seletorCoresUtil;
    ...
    public ContatoArrayAdapter(Context context,int resource) {
        ...
        seletorCoresUtil = new SeletorCoresUtil();
    }
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        //viewHolder.lbl_cor.setBackgroundColor(context.getResources().getColor(seletorCoresUtil.setarCor(letraInicial)));
        viewHolder.lbl_cor.setBackground(context.getResources().getDrawable(seletorCoresUtil.setarCor(letraInicial)));
